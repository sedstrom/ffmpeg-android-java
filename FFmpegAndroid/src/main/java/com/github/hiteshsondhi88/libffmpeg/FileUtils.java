...
class FileUtils {
    ...
    static boolean copyBinaryFromRawToData(Context context, String outputFileName) {
    ...
    public static String getLatestFfmpegSha1(Context context) {
        return context.getResources().getString(R.string.sha1);
    }
}